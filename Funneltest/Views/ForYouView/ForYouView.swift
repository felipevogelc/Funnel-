...
struct ForYouView: View {
    @StateObject var forYouViewModel = ForYouViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    HStack {
                        HStack {
                            ...
                            HStack {
                                ...
                                TextField(StringConstants.kLblForYou2,
                                          text: $forYouViewModel.groupfifteen)
                    ...
                    ZStack(alignment: .center) {
                        Divider()
                            ...
                            .padding(.top, getRelativeHeight(685.0))
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            Image("img_tacoshoptest")
                                ...
                                .clipped()
                                .onTapGesture {
                                    forYouViewModel.nextScreen = "Menu1View"
                                }
                            VStack {
                                HStack {
                        ...
                        Text("tabbar")
                            ...
                            .padding(.top, getRelativeHeight(646.0))
                    }
                    .hideNavigationBar()
                ...
                Group {
                    NavigationLink(destination: Menu1View(),
                                   tag: "Menu1View",
                                   selection: $forYouViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
