...
struct ExamplefunneltacooverlayView: View {
    @StateObject var examplefunneltacooverlayViewModel = ExamplefunneltacooverlayViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    VStack {
                        ...
                        Text(StringConstants.kLblTacos3)
                            .font(FontScheme.kNunitoSemiBold(size: getRelativeHeight(28.0)))
                            .fontWeight(.semibold)
                            .foregroundColor(ColorConstants.Black900)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(73.0), height: getRelativeHeight(28.0),
                                   alignment: .topLeading)
                            .padding(.top, getRelativeHeight(31.0))
                            .padding(.horizontal, getRelativeWidth(21.0))
                        Text(StringConstants.kMsgBuy2Get1Tac2)
                        ...
                        Text(StringConstants.kLbl35Month)
                            .font(FontScheme.kNunitoMedium(size: getRelativeHeight(20.0)))
                            .fontWeight(.medium)
                            .foregroundColor(ColorConstants.Black900)
                            .minimumScaleFactor(0.5)
                        ...
                        .padding(.horizontal, getRelativeWidth(26.0))
                        Text(StringConstants.kMsg35MonthBill)
                            .font(FontScheme.kNunitoMedium(size: getRelativeHeight(14.0)))
                            .fontWeight(.medium)
                            .foregroundColor(ColorConstants.Black900)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(207.0), height: getRelativeHeight(128.0),
                                   alignment: .topLeading)
...
struct ExamplefunneltacooverlayView_Previews: PreviewProvider {
    static var previews: some View {
        ExamplefunneltacooverlayView()
    }
}
